	...
	with open("/home/bot/catkin_ws/src/projet_fetch/txt/desktop_list.txt", "r") as f:
		...
		if compteur%2==0 :
			if bureau_to_reach :
				...
				desktop_goal_pub.publish(desktop)
		else :	
...
if __name__ == '__main__':
	...
	rospy.Subscriber('/desktop_nam', desktop_name, get_desktop_goal)
	rospy.Subscriber('/desktop_name_to_supress',desktop_name, get_desktop_to_suppress)
	
	# Sending goal_pos
	desktop_goal_pub = rospy.Publisher('/move_base_simple/goal', PoseStamped, queue_size= 10)
